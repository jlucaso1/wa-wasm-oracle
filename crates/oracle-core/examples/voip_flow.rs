...
//!
//! ```sh
//! cargo run --release --example voip_flow -- <path to D5pLH9sfOOl.wasm>
//! ```
...
fn main() -> anyhow::Result<()> {
    ...
    for shape in shapes {
        ...
        println!(
            ...
            accept_lines.len(),
            r.all_calls_to("env::sendSignalingXMPP_js_sync").len()
        );
        ...
        let events = r.all_calls_to("env::on_call_event_js_sync").len();
        println!(
